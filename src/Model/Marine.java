...
public class Marine extends Unit{
	...
	public Marine(String name) {
		...
		super(40, 15, name, 10, true);	//super : Unit(int hp, int attack, String name, boolean airAttackAble) 호출
	}
/*	
	public void inform() {//재정의 : 오버라이드 / Unit에서 정의한 메소드를 Marine에서 다시 정의함 / 오른쪽 세모로 표시됨 (초록색)
